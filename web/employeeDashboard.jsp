...
<body>   
    ...
    <p>This is your <%= session.getAttribute("role") %> Dashboard.</p>
     <a href="applyLeave.jsp">Apply for Leave</a><br>
    <a href="LogoutServlet">Logout</a> --%>
    <div id="container">
    <div id="left-panel">
        <h2>Welcome, <%= session.getAttribute("name") %>!</h2>
        <p>This is your <%= session.getAttribute("role") %> Dashboard.</p>
        <!-- <a href="applyLeave.jsp">Apply for Leave</a> |  --><a href="LeaveStatusServlet">Apply for Leave</a> |
        <a href="LogoutServlet">Logout</a>
        <h3>Employee Tools</h3>
        <p>You can apply for leave.</p>
    </div>
